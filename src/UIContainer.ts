...
export class UIContainer extends LitElement {
    ...
    @property({
        ...
        converter: {
            fromAttribute: (value: string | null) => (value ? (JSON.parse(value) as PlayerConfiguration) : {})
        }
    })
    ...
    /**
     * Whether the user is considered to be "idle".
     */
    private get userIdle(): boolean {
    ...
    private isUserIdle_(): boolean {
        ...
        return this.userIdle && !this.paused && !this.casting && (this._menuGroupRef.value ? !this._menuGroupRef.value.hasCurrentMenu() : false);
    }
