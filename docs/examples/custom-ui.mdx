...
<Example className={styles.player} src={useBaseUrl('/open-video-ui/v1/examples/web/custom-ui/demo.html')}></Example>
...
<details>
    ...
    [📜 View full source on GitHub](https://github.com/THEOplayer/web-ui/blob/main/docs/static/open-video-ui/v1/examples/web/custom-ui/demo.html)
