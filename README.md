# THEOplayer Open Video UI for Web and React
...
The Open Video UI for Web is located in [the `web-ui` package](https://github.com/THEOplayer/web-ui/tree/main/packages/web-ui/).

## React

The Open Video UI for React is located in [the `react-ui` package](https://github.com/THEOplayer/web-ui/tree/main/packages/react-ui/).
